...
<meta name="csrf-token" content="b7HGL3PnM3Ug8jL3OO6eB5nXpIYvAMaM35H0a8AQd0YH16ofGIt0EFDGW5tB2KlE8r73zUxW_t20-MU-knZFdA==">
<title>Add Faq</title>
...
<ol class="breadcrumb"><li class='breadcrumb-item'> <a href="/admin/">Home</a> </li><li class='breadcrumb-item'> <a href="/admin/faq/index">Manage FAQ</a> </li><li class='breadcrumb-item active'> Add Faq </li></ol>                    </div>
</div>
<!-- ============================================================== -->
...
<hr>
<form id="form" class="form-horizontal form-material" action="/admin/faq/create" method="post">
<input type="hidden" name="_csrf" value="b7HGL3PnM3Ug8jL3OO6eB5nXpIYvAMaM35H0a8AQd0YH16ofGIt0EFDGW5tB2KlE8r73zUxW_t20-MU-knZFdA==">
<div class="form-group field-faq-title required">
<label class="control-label" for="faq-title">Title</label>
<input type="text" id="faq-title" class="form-control" name="Faq[title]" maxlength="255" placeholder="Enter Title" aria-required="true">

<div class="help-block"></div>
</div>
<div class="form-group field-faq-description required">
<label class="control-label" for="faq-description">Description</label>
<textarea id="faq-description" class="form-control" name="Faq[description]" rows="4" placeholder="Enter Description" aria-required="true"></textarea>

<div class="help-block"></div>
</div>
<div class="form-group">
<button type="submit" class="btn btn-success  waves-effect waves-light">Save</button>                    <a class="btn btn-info" href="/admin/faq">Cancel</a>			    </div>
