...
<ol class="breadcrumb"><li class='breadcrumb-item'> <a href="admin.html">Home</a> </li><li class='breadcrumb-item active'> Update Password </li></ol>                    </div>
</div>
<!-- ============================================================== -->
...
<hr>
<form id="changepassword-form" class="form-horizontal form-material" action="changepassword.html" method="post">
<input type="hidden" name="_csrf" value="n-2YziOfxkRqrMjk6CBn6UaUDrBaSvGgb8Ecsco4Ypb7n_y_RtHyLSHq-7veZlSRCPpr-TspofcjlWvcuWIM1Q==">                    <div class="form-group field-resetpasswordform-oldpass required">
<label class="control-label" for="resetpasswordform-oldpass">Old Password</label>
<input type="password" id="resetpasswordform-oldpass" class="form-control" name="ResetPasswordForm[oldpass]" placeholder="" aria-required="true">

<p class="text-danger"></p>
</div>                   
<div class="form-group field-resetpasswordform-newpass required">
<label class="control-label" for="resetpasswordform-newpass">New Password</label>
<input type="password" id="resetpasswordform-newpass" class="form-control" name="ResetPasswordForm[newpass]" placeholder="" aria-required="true">

<p class="text-danger"></p>
</div>                   
<div class="form-group field-resetpasswordform-repeatnewpass required">
<label class="control-label" for="resetpasswordform-repeatnewpass">Repeat New Password</label>
<input type="password" id="resetpasswordform-repeatnewpass" class="form-control" name="ResetPasswordForm[repeatnewpass]" placeholder="" aria-required="true">

<p class="text-danger"></p>
</div>                   
<div class="form-group">
<button type="submit" class="btn btn-success waves-effect waves-light">Save</button>                        <a class="btn btn-info waves-effect waves-light" href="dashboard.html">Cancel</a>                    </div>
</form>            </div>
</div>
</div>
</div>                <!-- ============================================================== -->
...
jQuery('#changepassword-form').yiiActiveForm([{"id":"resetpasswordform-oldpass","name":"oldpass","container":".field-resetpasswordform-oldpass","input":"#resetpasswordform-oldpass","error":".text-danger","validate":function (attribute, value, messages, deferred, $form) {yii.validation.required(value, messages, {"message":"Old Password cannot be blank."});}},{"id":"resetpasswordform-newpass","name":"newpass","container":".field-resetpasswordform-newpass","input":"#resetpasswordform-newpass","error":".text-danger","validate":function (attribute, value, messages, deferred, $form) {yii.validation.required(value, messages, {"message":"New Password cannot be blank."});}},{"id":"resetpasswordform-repeatnewpass","name":"repeatnewpass","container":".field-resetpasswordform-repeatnewpass","input":"#resetpasswordform-repeatnewpass","error":".text-danger","validate":function (attribute, value, messages, deferred, $form) {yii.validation.required(value, messages, {"message":"Repeat Password cannot be blank."});yii.validation.compare(value, messages, {"operator":"==","type":"string","compareAttribute":"resetpasswordform-newpass","skipOnEmpty":1,"message":"Repeat Password must be equal to \"New Password\"."}, $form);}}], {"errorCssClass":"has-danger"});
});</script></body>
</html>
