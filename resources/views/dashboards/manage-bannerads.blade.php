...
<ol class="breadcrumb"><li class='breadcrumb-item'> <a href="admin.html">Home</a> </li><li class='breadcrumb-item active'> Manage Banner </li></ol>                    </div>
</div>
<!-- ============================================================== -->
...
<p>
<a class="btn btn-rounded btn-outline-info"  href="create-bannerads">
...
<h3 class="card-title m-b-0">Manage Banner</h3>
</div>
<div class="card-body collapse show">
<div class="table-responsive">
<div id="user-grid" class="grid-view"><table class="table product-overview"><thead>
<tr class="thead-inverse"><th>#</th><th>Banner image</th><th>Redirect Url</th><th>Created At</th><th>Current Status</th><th style="width:10%">&nbsp;</th></tr>
</thead>
<tbody>
<tr data-key="8"><td>1</td><td><div class="avatar">
<a class="single_image" href="images/banner.png">
<img src="images/banner.png" class=" radious" alt="Banner Image" height = "55px" width="65px">    
</a>                                   
</div></td><td><a href="https://youtu.be/pIXENIOgquA">https://youtu.be/pIXENIOgquA</a></td><td>2018-02-01 01:23 PM</td><td><a class="btn btn-success" href="/admin/bannerads/changestatus?id=OA%253D%253D" title="Click here to inactivate" data-toggle="tooltip">Active</a></td><td><a class="text-inverse p-r-10" href="/admin/bannerads/update/8" data-toggle="tooltip" data-original-title="Edit"><i class="ti-marker-alt"></i></a> <a class="text-inverse" href="/admin/bannerads/delete/8" data-toggle="tooltip" data-original-title="Delete" data-confirm="Are you sure to delete this banner?." data-method="post"><i class="ti-trash"></i></a></td></tr>
</tbody></table>
<div align='center'>Showing 1 - 1 of 1 record(s)
</div></div>            </div>
</div>
</div>
</div>
...
jQuery('#user-grid').yiiGridView({"filterUrl":"\/manage-bannerads.html","filterSelector":"#user-grid-filters input, #user-grid-filters select"});
});</script></body>
</html>