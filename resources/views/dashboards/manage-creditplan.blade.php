...
<title>Manage Credit Plan</title>
...
<ol class="breadcrumb"><li class='breadcrumb-item'> <a href="admin.html">Home</a> </li><li class='breadcrumb-item active'> Manage Credit Plan </li></ol>                    </div>
</div>
<!-- ============================================================== -->
...
<p>
<a class="btn btn-rounded btn-outline-info"  href="create-creditplan.html">
...
<h3 class="card-title m-b-0">Manage Credit Plan</h3>
</div>
<div class="card-body collapse show">
<div class="table-responsive">
<div id="w0" class="grid-view"><table class="table product-overview"><thead>
<tr class="thead-inverse"><th>#</th><th style="min-width: 150px">Title</th><th style="min-width: 200px">Description</th><th style="min-width: 120px">Price in $</th><th style="min-width: 120px">Credit in $</th><th style="min-width: 60px"></th><th>Sequence</th><th class="text-center" style="min-width: 120px;">Current Status</th><th class="text-center" style="min-width: 220px;">Created At</th><th class="action-column">Actions</th></tr><tr id="w0-filters" class="filters"><td>&nbsp;</td><td><input type="text" id="creditplansearch-title" class="form-control" name="CreditPlanSearch[title]" placeholder="Search By Title"></td><td><input type="text" id="creditplansearch-description" class="form-control" name="CreditPlanSearch[description]" placeholder="Search By Description"></td><td><input type="text" id="creditplansearch-price" class="form-control" name="CreditPlanSearch[price]" placeholder="Search By Price"></td><td><input type="text" id="creditplansearch-credit" class="form-control" name="CreditPlanSearch[credit]" placeholder="Search By Credit"></td><td>&nbsp;</td><td>&nbsp;</td><td><select id="creditplansearch-is_active" class="form-control selectpicker" name="CreditPlanSearch[is_active]">
<option value="">All</option>
<option value="Y">Active</option>
<option value="N">Inactive</option>
</select></td><td><input type="text" id="creditplansearch-created_at" class="form-control" name="CreditPlanSearch[created_at]" placeholder="Search By Created At"></td><td>&nbsp;</td></tr>
</thead>
<tbody>
<tr data-key="3"><td>1</td><td>Category 1</td><td>In this category (1) you will be able to bid for items from $1 up to $100 with a bid cost of 0.10cents per bid.</td><td>10</td><td>100</td><td width="10%">
<form id='form_3' action='/admin/creditplan/changeorder' method='POST' class='form-horizontal form-material'>
<input type='hidden' value='4' name='total'>
<input type='hidden' value='3' name='id'>
<input type='hidden' value='1' name='current'>
<input type='text' value='1' class='form-control' name='target'>
</form>
</td><td><a href='javascript:;' class='btn btn-info submit-order' id='3' >Change</a></td><td><a class="btn btn-success" href="/admin/creditplan/changestatus?id=Mw%253D%253D" title="Click here to inactivate" data-toggle="tooltip">Active</a></td><td>2018-01-04 08:50 PM</td><td><a class="text-inverse p-r-10" href="/admin/creditplan/update/3" data-toggle="tooltip" data-original-title="Edit"><i class="ti-marker-alt"></i></a> <a class="text-inverse" href="/admin/creditplan/delete/3" data-toggle="tooltip" data-original-title="Delete" data-confirm="Are you sure to delete this credit plan?." data-method="post"><i class="ti-trash"></i></a></td></tr>
<tr data-key="2"><td>2</td><td>Category 2</td><td>In this category (2) you will be able to bid for items from $100 up to $3500 with a bid cost of 0.35cents per bid.</td><td>20</td><td>57</td><td width="10%">
<form id='form_2' action='/admin/creditplan/changeorder' method='POST' class='form-horizontal form-material'>
<input type='hidden' value='4' name='total'>
<input type='hidden' value='2' name='id'>
<input type='hidden' value='2' name='current'>
<input type='text' value='2' class='form-control' name='target'>
</form>
</td><td><a href='javascript:;' class='btn btn-info submit-order' id='2' >Change</a></td><td><a class="btn btn-success" href="/admin/creditplan/changestatus?id=Mg%253D%253D" title="Click here to inactivate" data-toggle="tooltip">Active</a></td><td>2018-01-04 08:49 PM</td><td><a class="text-inverse p-r-10" href="/admin/creditplan/update/2" data-toggle="tooltip" data-original-title="Edit"><i class="ti-marker-alt"></i></a> <a class="text-inverse" href="/admin/creditplan/delete/2" data-toggle="tooltip" data-original-title="Delete" data-confirm="Are you sure to delete this credit plan?." data-method="post"><i class="ti-trash"></i></a></td></tr>
<tr data-key="4"><td>3</td><td>Category 3</td><td>In this category (3) you will be able to bid for items from $3500 up to $8000 with a bid cost of 0.73cents per bid.</td><td>20</td><td>27</td><td width="10%">
<form id='form_4' action='/admin/creditplan/changeorder' method='POST' class='form-horizontal form-material'>
<input type='hidden' value='4' name='total'>
<input type='hidden' value='4' name='id'>
<input type='hidden' value='3' name='current'>
<input type='text' value='3' class='form-control' name='target'>
</form>
</td><td><a href='javascript:;' class='btn btn-info submit-order' id='4' >Change</a></td><td><a class="btn btn-success" href="/admin/creditplan/changestatus?id=NA%253D%253D" title="Click here to inactivate" data-toggle="tooltip">Active</a></td><td>2018-02-05 06:52 PM</td><td><a class="text-inverse p-r-10" href="/admin/creditplan/update/4" data-toggle="tooltip" data-original-title="Edit"><i class="ti-marker-alt"></i></a> <a class="text-inverse" href="/admin/creditplan/delete/4" data-toggle="tooltip" data-original-title="Delete" data-confirm="Are you sure to delete this credit plan?." data-method="post"><i class="ti-trash"></i></a></td></tr>
<tr data-key="5"><td>4</td><td>Category 4</td><td>In this category (4) you will be able to bid for items from $8000 up to $9500 with a bid cost of 0.99cents per bid.</td><td>100</td><td>101</td><td width="10%">
<form id='form_5' action='/admin/creditplan/changeorder' method='POST' class='form-horizontal form-material'>
<input type='hidden' value='4' name='total'>
...
</td><td><a href='javascript:;' class='btn btn-info submit-order' id='5' >Change</a></td><td><a class="btn btn-success" href="/admin/creditplan/changestatus?id=NQ%253D%253D" title="Click here to inactivate" data-toggle="tooltip">Active</a></td><td>2018-02-05 07:17 PM</td><td><a class="text-inverse p-r-10" href="/admin/creditplan/update/5" data-toggle="tooltip" data-original-title="Edit"><i class="ti-marker-alt"></i></a> <a class="text-inverse" href="/admin/creditplan/delete/5" data-toggle="tooltip" data-original-title="Delete" data-confirm="Are you sure to delete this credit plan?." data-method="post"><i class="ti-trash"></i></a></td></tr>
</tbody></table>
<div align='center'>Showing 1 - 4 of 4 record(s)
</div></div>            </div>
</div>
</div>
</div>
...
jQuery('#w0').yiiGridView({"filterUrl":"\/manage-creditplan.html","filterSelector":"#w0-filters input, #w0-filters select"});
});</script></body>
</html>
