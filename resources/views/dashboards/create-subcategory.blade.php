...
<ol class="breadcrumb"><li class='breadcrumb-item'> <a href="/admin/">Home</a> </li><li class='breadcrumb-item'> <a href="/admin/subcategory/index">Manage Sub Category</a> </li><li class='breadcrumb-item active'> Add Sub Category </li></ol>                    </div>
</div>
<!-- ============================================================== -->
...
<hr>
<form id="form" class="form-horizontal form-material" action="/admin/subcategory/create" method="post" enctype="multipart/form-data">
<input type="hidden" name="_csrf" value="nVDPiSVGyTlXcbkOg3aMXUauH_6LKcukYiFeoKzGcE3oAIjDHBK5bCYez2-2Pvw8EsRJsud6qsEQaAfHx4oxDg==">           <!--      <select id="example-multiple-optgroups" multiple="multiple">
...
<div class="form-group field-subcategory-category_id required">
<label class="control-label" for="subcategory-category_id">Category</label>
<select id="subcategory-category_id" class="form-control" name="SubCategory[category_id]" title="Select Company" aria-required="true">
...
</div>                <div class="form-group field-subcategory-name required">
<label class="control-label" for="subcategory-name">Name</label>
<input type="text" id="subcategory-name" class="form-control" name="SubCategory[name]" maxlength="255" placeholder="Enter Name" aria-required="true">

<div class="help-block"></div>
</div>                <!-- <img class="profile-pic  img-thumbnail" src="" height="95px" width="95px" />
...
<div class="form-group field-subcategory-is_active">
<label class="control-label" for="subcategory-is_active">Is Active</label>
<select id="subcategory-is_active" class="form-control" name="SubCategory[is_active]">
...
<div class="form-group">
<button type="submit" class="btn btn-success  waves-effect waves-light">Save</button>                    <a class="btn btn-info" href="manage-subcategory.html">Cancel</a>                </div>
</form>            </div>
</div>
</div>
</div>
...
jQuery('#form').yiiActiveForm([{"id":"subcategory-category_id","name":"category_id","container":".field-subcategory-category_id","input":"#subcategory-category_id","validate":function (attribute, value, messages, deferred, $form) {yii.validation.required(value, messages, {"message":"Category cannot be blank."});}},{"id":"subcategory-name","name":"name","container":".field-subcategory-name","input":"#subcategory-name","validate":function (attribute, value, messages, deferred, $form) {yii.validation.required(value, messages, {"message":"Name cannot be blank."});yii.validation.string(value, messages, {"message":"Name must be a string.","max":255,"tooLong":"Name should contain at most 255 characters.","skipOnEmpty":1});}},{"id":"subcategory-is_active","name":"is_active","container":".field-subcategory-is_active","input":"#subcategory-is_active","validate":function (attribute, value, messages, deferred, $form) {yii.validation.string(value, messages, {"message":"Is Active must be a string.","skipOnEmpty":1});}}], []);
});</script></body>
</html>
