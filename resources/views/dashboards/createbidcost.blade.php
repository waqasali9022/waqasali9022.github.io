...
<ol class="breadcrumb"><li class='breadcrumb-item'> <a href="admin.html">Home</a> </li><li class='breadcrumb-item'> <a href="bidcostindex.html">Bidding Cost</a> </li><li class='breadcrumb-item active'> Add Bidding Cost </li></ol>                    </div>
</div>
<!-- ============================================================== -->
...
<div class="card">
<div class="card-body">
<h4 class="card-title">Add Bidding Cost</h4>
<!-- <h6 class="card-subtitle">Just add <code>form-material</code> class to the form that's it.</h6> -->
<hr>
<form id="form" class="form-horizontal form-material" action="createbidcost.html" method="post">
<input type="hidden" name="_csrf" value="BQQQQEeuILDWj8c2pBUTC-IPMndjaZBTjdsV_s3RvjFhdnQxIuAU2Z3J9GmSUyBzrGFXPgIKwATBj2KTvovQcg==">
<div class="form-group field-bidcost-from_price_range required">
<label class="control-label" for="bidcost-from_price_range">From Price Range</label>
<input type="text" id="bidcost-from_price_range" class="form-control" name="BidCost[from_price_range]" ="" onkeypress="return isNumberKey(event)" placeholder="Enter Price" aria-required="true">

<div class="help-block"></div>
</div>
<div class="form-group field-bidcost-to_price_range required">
<label class="control-label" for="bidcost-to_price_range">To Price Range</label>
<input type="text" id="bidcost-to_price_range" class="form-control" name="BidCost[to_price_range]" ="" onkeypress="return isNumberKey(event)" placeholder="Enter Price" aria-required="true">

<div class="help-block"></div>
</div>
<div class="form-group field-bidcost-bid_rate required">
<label class="control-label" for="bidcost-bid_rate">Bid Rate in $</label>
<input type="text" id="bidcost-bid_rate" class="form-control" name="BidCost[bid_rate]" onkeypress="return isNumberKey(event)" placeholder="Enter Rate" aria-required="true">

<div class="help-block"></div>
</div>
<div class="form-group">
<button type="submit" class="btn btn-success  waves-effect waves-light">Save</button>                    <a class="btn btn-info" href="/admin/bidcost">Cancel</a>               </div>
...
jQuery('#form').yiiActiveForm([{"id":"bidcost-from_price_range","name":"from_price_range","container":".field-bidcost-from_price_range","input":"#bidcost-from_price_range","validate":function (attribute, value, messages, deferred, $form) {yii.validation.required(value, messages, {"message":"From Price Range cannot be blank."});yii.validation.number(value, messages, {"pattern":/^\s*[-+]?[0-9]*\.?[0-9]+([eE][-+]?[0-9]+)?\s*$/,"message":"From Price Range must be a number.","skipOnEmpty":1});}},{"id":"bidcost-to_price_range","name":"to_price_range","container":".field-bidcost-to_price_range","input":"#bidcost-to_price_range","validate":function (attribute, value, messages, deferred, $form) {yii.validation.required(value, messages, {"message":"To Price Range cannot be blank."});yii.validation.number(value, messages, {"pattern":/^\s*[-+]?[0-9]*\.?[0-9]+([eE][-+]?[0-9]+)?\s*$/,"message":"To Price Range must be a number.","skipOnEmpty":1});yii.validation.compare(value, messages, {"operator":">","type":"number","compareAttribute":"bidcost-from_price_range","skipOnEmpty":1,"message":"To Price Range must be greater than \"From Price Range\"."}, $form);}},{"id":"bidcost-bid_rate","name":"bid_rate","container":".field-bidcost-bid_rate","input":"#bidcost-bid_rate","validate":function (attribute, value, messages, deferred, $form) {yii.validation.required(value, messages, {"message":"Bid Rate in $ cannot be blank."});yii.validation.number(value, messages, {"pattern":/^\s*[-+]?[0-9]*\.?[0-9]+([eE][-+]?[0-9]+)?\s*$/,"message":"Bid Rate in $ must be a number.","skipOnEmpty":1});}}], []);
});</script></body>
</html>
