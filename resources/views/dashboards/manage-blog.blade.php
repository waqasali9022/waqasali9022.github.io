...
<ol class="breadcrumb"><li class='breadcrumb-item'> <a href="admin.html">Home</a> </li><li class='breadcrumb-item active'> Manage Blog </li></ol>                    </div>
</div>
<!-- ============================================================== -->
...
<p>
<a class="btn btn-rounded btn-outline-info"  href="create-blog.html">
...
<h3 class="card-title m-b-0">Manage Blog</h3>
</div>
<div class="card-body collapse show">
<div class="table-responsive">
<div id="w0" class="grid-view"><table class="table product-overview"><thead>
<tr class="thead-inverse"><th>#</th><th>Image</th><th>Title</th><th>Short Description</th><th>Current Status</th><th>Created At</th><th style="min-width: 100px;">Actions</th></tr><tr id="w0-filters" class="filters"><td>&nbsp;</td><td>&nbsp;</td><td><input type="text" id="blogsearch-title" class="form-control" name="BlogSearch[title]" placeholder="Search By Title"></td><td><input type="text" id="blogsearch-short_description" class="form-control" name="BlogSearch[short_description]" placeholder="Search By Description"></td><td><select id="blogsearch-is_active" class="form-control selectpicker" name="BlogSearch[is_active]">
<option value="">All</option>
<option value="Y">Active</option>
<option value="N">Inactive</option>
</select></td><td>&nbsp;</td><td>&nnbsp;</td></tr>
</thead>
<tbody>
<tr data-key="7"><td>1</td><td><div class="avatar">
<a class="single_image" href="images/blog1.jpeg">
<img src="images/blog1.jpeg" class=" radious" alt="image_url" height = "45px" width="55px">    
</a>                                   
</div></td><td>Test</td><td>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like readable Eng</td><td><a class="btn btn-success" href="/admin/blog/changestatus?id=Nw%253D%253D" title="Click here to inactivate" data-toggle="tooltip">Active</a></td><td>2018-02-21 01:39 PM</td><td><a class="text-inverse p-r-10" href="/admin/blog/7" data-toggle="tooltip" data-original-title="View"><i class="fa fa-eye"></i></a> <a class="text-inverse p-r-10" href="/admin/blog/update/7" data-toggle="tooltip" data-original-title="Edit"><i class="ti-marker-alt"></i></a> <a class="text-inverse" href="/admin/blog/delete/7" data-toggle="tooltip" data-original-title="Delete" data-confirm="Are you sure to delete this blog?" data-method="post"><i class="ti-trash"></i></a></td></tr>
<tr data-key="3"><td>2</td><td><div class="avatar">
<a class="single_image" href="images/blog2.jpeg">
<img src="images/blog2.jpeg" class=" radious" alt="image_url" height = "45px" width="55px">    
</a>                                   
</div></td><td>Why do we use it?</td><td>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like readable Eng</td><td><a class="btn btn-success" href="/admin/blog/changestatus?id=Mw%253D%253D" title="Click here to inactivate" data-toggle="tooltip">Active</a></td><td>2018-01-16 07:36 PM</td><td><a class="text-inverse p-r-10" href="/admin/blog/3" data-toggle="tooltip" data-original-title="View"><i class="fa fa-eye"></i></a> <a class="text-inverse p-r-10" href="/admin/blog/update/3" data-toggle="tooltip" data-original-title="Edit"><i class="ti-marker-alt"></i></a> <a class="text-inverse" href="/admin/blog/delete/3" data-toggle="tooltip" data-original-title="Delete" data-confirm="Are you sure to delete this blog?" data-method="post"><i class="ti-trash"></i></a></td></tr>
</tbody></table>
<div align='center'>Showing 1 - 2 of 2 record(s)
</div></div>            </div>
</div>
</div>
</div>
...
jQuery('#w0').yiiGridView({"filterUrl":"\/manage-blog.html","filterSelector":"#w0-filters input, #w0-filters select"});
});</script></body>
</html>