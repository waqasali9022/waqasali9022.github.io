...
<ol class="breadcrumb"><li class='breadcrumb-item'> <a href="admin.html">Home</a> </li><li class='breadcrumb-item'> <a href="manage-blog.html">Manage Blog</a> </li><li class='breadcrumb-item active'> Add Blog </li></ol>                    </div>
</div>
<!-- ============================================================== -->
...
<hr>
<form id="form" class="form-horizontal form-material" action="create-blog.html" method="post" enctype="multipart/form-data">
<input type="hidden" name="_csrf" value="L-HUg8asCV14lHRqbk9JE_AhYj-2fkLGtsA6vEpa1llasZPJ__h5CAn7AgtbBzlypEs0c9otI6PEiWPbIRaXGg==">
<div class="form-group field-blog-title required">
<label class="control-label" for="blog-title">Title</label>
<input type="text" id="blog-title" class="form-control" name="Blog[title]" maxlength="255" aria-required="true">

<div class="help-block"></div>
</div>

<div style="float: right;"> <span id="title_length">0</span> / 300</div>
<div class="form-group field-blog-short_description required">
<label class="control-label" for="blog-short_description">Short Description</label>
<textarea id="blog-short_description" class="form-control" name="Blog[short_description]" maxlength="300" rows="4" aria-required="true"></textarea>

<div class="help-block"></div>
</div>
<div class="form-group field-summernote required">
<label class="control-label" for="summernote">Description</label>
<textarea id="summernote" class="form-control" name="Blog[description]" rows="4" aria-required="true"></textarea>
...
<input class="file-upload custom-file-input" type="file" accept="image/*" name="Blog[image_url]" />
<span class="custom-file-control">Select Blog Image</span>
</label>    
<div class="help-block"></div>

</div>                
<div class="form-group field-blog-is_active">
<label class="control-label" for="blog-is_active">Is Active</label>
<select id="blog-is_active" class="form-control" name="Blog[is_active]">
...
<div class="form-group">
<button type="submit" class="btn btn-success  waves-effect waves-light">Add</button>                    <a class="btn btn-info" href="/admin/blog">Cancel</a>                </div>
...
$("#blog-short_description").keyup(function () {
var str_length = $(this).val().length;
$("#title_length").empty();
$("#title_length").html(str_length);
});
});
...
jQuery('#form').yiiActiveForm([{"id":"blog-title","name":"title","container":".field-blog-title","input":"#blog-title","validate":function (attribute, value, messages, deferred, $form) {yii.validation.required(value, messages, {"message":"Title cannot be blank."});yii.validation.string(value, messages, {"message":"Title must be a string.","max":255,"tooLong":"Title should contain at most 255 characters.","skipOnEmpty":1});}},{"id":"blog-short_description","name":"short_description","container":".field-blog-short_description","input":"#blog-short_description","validate":function (attribute, value, messages, deferred, $form) {yii.validation.required(value, messages, {"message":"Short Description cannot be blank."});yii.validation.string(value, messages, {"message":"Short Description must be a string.","max":300,"tooLong":"Short Description should contain at most 300 characters.","skipOnEmpty":1});}},{"id":"blog-description","name":"description","container":".field-summernote","input":"#summernote","validate":function (attribute, value, messages, deferred, $form) {yii.validation.required(value, messages, {"message":"Description cannot be blank."});yii.validation.string(value, messages, {"message":"Description must be a string.","skipOnEmpty":1});}},{"id":"blog-is_active","name":"is_active","container":".field-blog-is_active","input":"#blog-is_active","validate":function (attribute, value, messages, deferred, $form) {yii.validation.string(value, messages, {"message":"Is Active must be a string.","skipOnEmpty":1});}}], []);
});</script>
</body>
</html>