...
<meta name="csrf-token" content="M2u6frwBUqxqLMcGM7nzoPIGlmZdB3xBkD5V2HyykVl8HIoR-lMU-AZCs01S8aDhsTTbHBNJTi_BeyWVNdjZNw==">
...
<!-- Dark Logo icon -->
<img src="/admin/web/theme/assets/images/logo-icon.png" alt="homepage" class="dark-logo" />
<!-- Light Logo icon -->
<img src="/admin/web/theme/assets/images/logo-light-icon.png" alt="homepage" class="light-logo" />
</b>
<!--End Logo icon -->
<!-- Logo text -->
<span>
<!-- dark Logo text -->
<img src="/admin/web/theme/assets/images/logo-text.png" alt="homepage" class="dark-logo" />
<!-- Light Logo text -->    
<img src="/admin/web/theme/assets/images/logo-light-text.png" alt="homepage"  class="light-logo" alt="homepage" height="30px" width="148px" /></span> </a>
</div>
<!-- ============================================================== -->
<!-- End Logo -->
<!-- ============================================================== -->
...
<li>
<a class="nav-link text-center" href="/admin/notification"> <strong>Check all notifications</strong> <i class="fa fa-angle-right"></i> </a>
</li>
</ul>
</div>
</li>
...
<!-- ============================================================== -->
<li class="nav-item dropdown">
<a class="nav-link dropdown-toggle text-muted waves-effect waves-dark" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="/admin/" alt="user" class="profile-pic" /></a>
<div class="dropdown-menu dropdown-menu-right scale-up">
<ul class="dropdown-user">
<li>
<div class="dw-user-box">
<div class="u-img"><img src="/admin/" alt="user"></div>
<div class="u-text">
<h4>buyingin</h4>
<p class="text-muted"></p><a href="/admin/site/updateprofile" class="btn btn-rounded btn-danger btn-sm">Update Profile</a></div>
</div>
</li>
<li role="separator" class="divider"></li>
<li><a href="/admin/site/changepassword"><i class="fa fa-key"></i> Change Password</a></li>
<li><a href="/admin/site/logout"><i class="fa fa-power-off"></i> Logout</a></li>
</ul>
</div>
</li>
</ul>
...
<ol class="breadcrumb"><li class='breadcrumb-item'> <a href="/admin/">Home</a> </li><li class='breadcrumb-item'> <a href="/admin/category/index">Manage Category</a> </li><li class='breadcrumb-item active'> Add Category </li></ol>                    </div>
</div>
<!-- ============================================================== -->
...
<hr>
<form id="form" class="form-horizontal form-material" action="/admin/category/create" method="post" enctype="multipart/form-data">
<input type="hidden" name="_csrf" value="M2u6frwBUqxqLMcGM7nzoPIGlmZdB3xBkD5V2HyykVl8HIoR-lMU-AZCs01S8aDhsTTbHBNJTi_BeyWVNdjZNw==">
<div class="form-group field-category-name required">
<label class="control-label" for="category-name">Name</label>
<input type="text" id="category-name" class="form-control" name="Category[name]" maxlength="255" placeholder="Enter Name" aria-required="true">

<div class="help-block"></div>
</div>
<img class="profile-pic hide img-thumbnail" src="" height="95px" width="95px" />
<div class="form-group">
<label class="custom-file">
<input class="file-upload custom-file-input" type="file" accept="image/*" name="Category[icon]" />
<span class="custom-file-control">Select Category Icon</span>
</label>    
<div class="help-block"></div>

</div>                
<div class="form-group field-category-is_active">
<label class="control-label" for="category-is_active">Is Active</label>
<select id="category-is_active" class="form-control" name="Category[is_active]">
...
<div class="form-group">
<button type="submit" class="btn btn-success  waves-effect waves-light">Add</button>                    <a class="btn btn-info" href="/admin/category">Cancel</a>                </div>
...
var readURL = function(input,from) {
...
jQuery('#form').yiiActiveForm([{"id":"category-name","name":"name","container":".field-category-name","input":"#category-name","validate":function (attribute, value, messages, deferred, $form) {yii.validation.required(value, messages, {"message":"Name cannot be blank."});yii.validation.string(value, messages, {"message":"Name must be a string.","max":255,"tooLong":"Name should contain at most 255 characters.","skipOnEmpty":1});}},{"id":"category-is_active","name":"is_active","container":".field-category-is_active","input":"#category-is_active","validate":function (attribute, value, messages, deferred, $form) {yii.validation.string(value, messages, {"message":"Is Active must be a string.","skipOnEmpty":1});}}], []);
});</script></body>
</html>
