...
<ol class="breadcrumb"><li class='breadcrumb-item'> <a href="admin.html">Home</a> </li><li class='breadcrumb-item active'> Manage FAQ </li></ol>                    </div>
</div>
<!-- ============================================================== -->
...
<p>
<a class="btn btn-rounded btn-outline-info"  href="createfaq.html">
...
<h3 class="card-title m-b-0">Manage FAQ</h3>
</div>
<div class="card-body collapse show">
<div class="table-responsive">
<div id="w0" class="grid-view"><table class="table product-overview"><thead>
<tr class="thead-inverse"><th>#</th><th style="min-width: 200px">Title</th><th style="min-width: 200px">Description</th><th style="min-width: 200px">Created At</th><th class="action-column">Actions</th></tr><tr id="w0-filters" class="filters"><td>&nbsp;</td><td><input type="text" id="faqsearch-title" class="form-control" name="FaqSearch[title]" placeholder="Search By Title"></td><td><input type="text" id="faqsearch-description" class="form-control" name="FaqSearch[description]" placeholder="Search By Description"></td><td>&nbsp;</td><td>&nbsp;</td></tr>
</thead>
<tbody>
<tr data-key="1"><td>1</td><td>How do I use it?</td><td>Step 1: you would need to sign up (for free)
Step 2: Select the item or items that you would like to buy or bid for.
Step 3: Go into purchase credit and select the category or categories that would like to purchase bids for.
Step 4: Place as many or as little bids as you would like to on an item.

(If the item you bid does not sell we will fully refund your money)</td><td>2018-01-05 10:11 PM</td><td><a class="text-inverse p-r-10" href="updatefaq1.html" data-toggle="tooltip" data-original-title="Edit"><i class="ti-marker-alt"></i></a> <a class="text-inverse" href="deletefaq1.html" data-toggle="tooltip" data-original-title="Delete" data-confirm="Are you sure to delete this bid FAQ?." data-method="post"><i class="ti-trash"></i></a></td></tr>
<tr data-key="3"><td>2</td><td>How does it work?</td><td>All advertised items are given a time frame to sell, within that time anyone can purchase credits and place a bid.  Once the item has reached its value a countdown will begin. At the end of the countdown the person with the most amount of bids will have successfully bought the item or items.
For example:
A TV at a value of $1000 is listed for auction. It has a timeframe of two days. Person A purchases a bid pack and places places one bid  at 35c and then the auction starts. People start bidding, once enough bids have been reached to the value of $1000, the auction is live. Person B ends up with the highest  bids with a value of five bids and the product is won. Person B gets a TV valued at $1000 for $1.75. Unfortunately there can only be one winner and the other bidders lose their money.

If not enough people are bidding to reach the price of $1000, then the product is not sold and everyone receives back their money.</td><td>2018-02-03 06:43 PM</td><td><a class="text-inverse p-r-10" href="updatefaq3.html" data-toggle="tooltip" data-original-title="Edit"><i class="ti-marker-alt"></i></a> <a class="text-inverse" href="deletefaq3.html" data-toggle="tooltip" data-original-title="Delete" data-confirm="Are you sure to delete this bid FAQ?." data-method="post"><i class="ti-trash"></i></a></td></tr>
<tr data-key="5"><td>3</td><td>What is Buying in Cents</td><td>Buying in Cents is a bidding site. People can purchase bidding packs depending on the total value of the product. People place a bid starting at bid 1 and going up until the product reaches the value. 1000 people may bid and the winner gets the item at a fraction of the price!
If the reserve price is not met then all bidders will be credited back their bidding cost. </td><td>2018-03-19 05:54 PM</td><td><a class="text-inverse p-r-10" href="updatefaq5.html" data-toggle="tooltip" data-original-title="Edit"><i class="ti-marker-alt"></i></a> <a class="text-inverse" href="deletefaq5.html" data-toggle="tooltip" data-original-title="Delete" data-confirm="Are you sure to delete this bid FAQ?." data-method="post"><i class="ti-trash"></i></a></td></tr>
</tbody></table>
<div align='center'>Showing 1 - 3 of 3 record(s)
</div></div>            </div>
</div>
</div>
</div>
...
jQuery('#w0').yiiGridView({"filterUrl":"\/faq.html","filterSelector":"#w0-filters input, #w0-filters select"});
});</script>
</body>
</html>