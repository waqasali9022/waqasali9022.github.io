...
<ol class="breadcrumb"><li class='breadcrumb-item'> <a href="admin.html">Home</a> </li><li class='breadcrumb-item'> <a href="manage-bannerads">Manage Banner</a> </li><li class='breadcrumb-item active'> Create Banner </li></ol>                    </div>
</div>
<!-- ============================================================== -->
...
<hr>
<form id="form" class="form-horizontal form-material" action="create-bannerads.html" method="post" enctype="multipart/form-data">
<input type="hidden" name="_csrf" value="bwZkDuTj7cySF8Hlb_9rA6qVMCnx71BTGzuFC-q2DQoaViNE3bedmeN4t4Ratxti_v9mZZ28MTZpctxsgfpMSQ==">                <div class="form-group field-bannerads-redirect_url required">
<label class="control-label" for="bannerads-redirect_url">Redirect Url</label>
<input type="text" id="bannerads-redirect_url" class="form-control" name="BannerAds[redirect_url]" maxlength="255" placeholder="Enter Redirect URL" aria-required="true">

<div class="help-block"></div>
</div>
<img class="profile-pic1 hide img-thumbnail" src="" height="95px" width="95px" />

<div class="upload-button1">Upload image (Require image size => 1900 x 450)</div>
<div class="form-group field-bannerads-image_url required">

<input type="hidden" name="BannerAds[image_url]" value=""><input type="file" id="bannerads-image_url" class="file-upload1" name="BannerAds[image_url]" aria-required="true">

<div class="help-block"></div>
</div>
<div class="form-group">
<button type="submit" class="btn btn-success  waves-effect waves-light">Create</button>                    <a class="btn btn-info" href="/admin/city">Cancel</a>                </div>
...
jQuery('#form').yiiActiveForm([{"id":"bannerads-redirect_url","name":"redirect_url","container":".field-bannerads-redirect_url","input":"#bannerads-redirect_url","validate":function (attribute, value, messages, deferred, $form) {yii.validation.required(value, messages, {"message":"Redirect Url cannot be blank."});yii.validation.url(value, messages, {"pattern":/^(http|https):\/\/(([A-Z0-9][A-Z0-9_-]*)(\.[A-Z0-9][A-Z0-9_-]*)+)(?::\d{1,5})?(?:$|[?\/#])/i,"message":"Redirect Url is not a valid URL.","enableIDN":false,"skipOnEmpty":1});yii.validation.string(value, messages, {"message":"Redirect Url must be a string.","max":255,"tooLong":"Redirect Url should contain at most 255 characters.","skipOnEmpty":1});}},{"id":"bannerads-image_url","name":"image_url","container":".field-bannerads-image_url","input":"#bannerads-image_url","validate":function (attribute, value, messages, deferred, $form) {yii.validation.required(value, messages, {"message":"please upload image"});yii.validation.string(value, messages, {"message":"Image Url must be a string.","max":255,"tooLong":"Image Url should contain at most 255 characters.","skipOnEmpty":1});}}], []);
});</script></body>
</html>
