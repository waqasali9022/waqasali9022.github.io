...
<ol class="breadcrumb"><li class='breadcrumb-item'> <a href="admin.html">Home</a> </li><li class='breadcrumb-item active'> Update Profile </li></ol>                    </div>
</div>
<!-- ============================================================== -->
...
<hr>
<form id="changepassword-form" class="form-horizontal form-material" action="updateprofile.html" method="post" enctype="multipart/form-data">
<input type="hidden" name="_csrf" value="654ZyO1CZdgvyexXDbmREPc2kDLSyV8ddAWCnAtr9LOer335ixM1mX2c2Rh02KElklL2U7v9GVAkd9TmXB2FgA==">                    <div class="form-group field-adminuser-user_name required">
<label class="control-label" for="adminuser-user_name">User Name</label>
<input type="text" id="adminuser-user_name" class="form-control" name="AdminUser[user_name]" value="buyingin" placeholder="" aria-required="true">

<p class="text-danger"></p>
</div>                   
<div class="form-group field-adminuser-email required">
<label class="control-label" for="adminuser-email">Email</label>
<input type="text" id="adminuser-email" class="form-control" name="AdminUser[email]" value="" placeholder="" aria-required="true">

<p class="text-danger"></p>
</div>                   
<img class="profile-pic1  img-thumbnail" src="admin.html" height="95px" width="95px" />

<div class="upload-button1">Upload image</div>
<div class="form-group field-adminuser-image_url">

<input type="hidden" name="AdminUser[image_url]" value=""><input type="file" id="adminuser-image_url" class="file-upload1" name="AdminUser[image_url]" value="">
...
jQuery('#changepassword-form').yiiActiveForm([{"id":"adminuser-user_name","name":"user_name","container":".field-adminuser-user_name","input":"#adminuser-user_name","error":".text-danger","validate":function (attribute, value, messages, deferred, $form) {yii.validation.required(value, messages, {"message":"User Name cannot be blank."});}},{"id":"adminuser-email","name":"email","container":".field-adminuser-email","input":"#adminuser-email","error":".text-danger","validate":function (attribute, value, messages, deferred, $form) {yii.validation.required(value, messages, {"message":"Email cannot be blank."});}}], {"errorCssClass":"has-danger"});
});</script></body>
</html>