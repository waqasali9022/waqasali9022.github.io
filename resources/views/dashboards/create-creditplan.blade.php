...
<title>Create Credit Plan</title>
...
<ol class="breadcrumb"><li class='breadcrumb-item'> <a href="admin.html">Home</a> </li><li class='breadcrumb-item'> <a href="/admin/creditplan/index">Manage Credit Plan</a> </li><li class='breadcrumb-item active'> Create Credit Plan </li></ol>                    </div>
</div>
<!-- ============================================================== -->
...
<div class="card">
<div class="card-body">
<h4 class="card-title">Create Credit Plan</h4>
<!-- <h6 class="card-subtitle">Just add <code>form-material</code> class to the form that's it.</h6> -->
<hr>
<form id="form" class="form-horizontal form-material" action="/admin/creditplan/create" method="post" enctype="multipart/form-data">
<input type="hidden" name="_csrf" value="7492Lk5L87bj4B-vpmG19h6V6KAHXbtOgWqsMUfn_rKa3zFkdx-D45KPac6TKcWXSv--7GsO2ivzI_VWLKu_8Q==">                <div class="form-group field-creditplan-title required">
<label class="control-label" for="creditplan-title">Title</label>
<input type="text" id="creditplan-title" class="form-control" name="CreditPlan[title]" maxlength="255" placeholder="Enter Plan Title" aria-required="true">

<div class="help-block"></div>
</div>
<div class="form-group field-creditplan-description required">
<label class="control-label" for="creditplan-description">Description</label>
<textarea id="creditplan-description" class="form-control" name="CreditPlan[description]" rows="3" placeholder="Enter Description" aria-required="true"></textarea>

<div class="help-block"></div>
</div>
<div class="form-group field-creditplan-price required">
<label class="control-label" for="creditplan-price">Price in $</label>
<input type="text" id="creditplan-price" class="form-control" name="CreditPlan[price]" placeholder="Enter Price" aria-required="true">

<div class="help-block"></div>
</div>
<div class="form-group field-creditplan-credit required">
<label class="control-label" for="creditplan-credit">Credit in $</label>
<input type="text" id="creditplan-credit" class="form-control" name="CreditPlan[credit]" placeholder="Enter Credit" aria-required="true">

<div class="help-block"></div>
</div>
<div class="form-group field-creditplan-is_active">
<label class="control-label" for="creditplan-is_active">Is Active</label>
<select id="creditplan-is_active" class="form-control" name="CreditPlan[is_active]">
...
<button type="submit" class="btn btn-success  waves-effect waves-light">Create</button>                    <a class="btn btn-info" href="/admin/creditplan">Cancel</a>                </div>
...
jQuery('#form').yiiActiveForm([{"id":"creditplan-title","name":"title","container":".field-creditplan-title","input":"#creditplan-title","validate":function (attribute, value, messages, deferred, $form) {yii.validation.required(value, messages, {"message":"Title cannot be blank."});yii.validation.string(value, messages, {"message":"Title must be a string.","max":255,"tooLong":"Title should contain at most 255 characters.","skipOnEmpty":1});}},{"id":"creditplan-description","name":"description","container":".field-creditplan-description","input":"#creditplan-description","validate":function (attribute, value, messages, deferred, $form) {yii.validation.required(value, messages, {"message":"Description cannot be blank."});yii.validation.string(value, messages, {"message":"Description must be a string.","skipOnEmpty":1});}},{"id":"creditplan-price","name":"price","container":".field-creditplan-price","input":"#creditplan-price","validate":function (attribute, value, messages, deferred, $form) {yii.validation.required(value, messages, {"message":"Price in $ cannot be blank."});yii.validation.number(value, messages, {"pattern":/^\s*[-+]?[0-9]*\.?[0-9]+([eE][-+]?[0-9]+)?\s*$/,"message":"Price in $ must be a number.","skipOnEmpty":1});yii.validation.compare(value, messages, {"operator":">","type":"string","compareValue":0,"skipOnEmpty":1,"message":"Price in $ must be greater than \"0\"."}, $form);}},{"id":"creditplan-credit","name":"credit","container":".field-creditplan-credit","input":"#creditplan-credit","validate":function (attribute, value, messages, deferred, $form) {yii.validation.required(value, messages, {"message":"Credit in $ cannot be blank."});yii.validation.number(value, messages, {"pattern":/^\s*[-+]?[0-9]*\.?[0-9]+([eE][-+]?[0-9]+)?\s*$/,"message":"Credit in $ must be a number.","skipOnEmpty":1});yii.validation.compare(value, messages, {"operator":">","type":"string","compareValue":0,"skipOnEmpty":1,"message":"Credit in $ must be greater than \"0\"."}, $form);}},{"id":"creditplan-is_active","name":"is_active","container":".field-creditplan-is_active","input":"#creditplan-is_active","validate":function (attribute, value, messages, deferred, $form) {yii.validation.string(value, messages, {"message":"Is Active must be a string.","skipOnEmpty":1});}}], []);
});</script></body>
</html>
